    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'string' => 'Поле имени должно быть строкой',
            'max' => 'Поле имени не должно превышать :max.',
        ],
        'email' => [
            'required' => 'Поле почты обязательно для заполнения',
            'string' => 'Поле почты должно быть строкой',
            'lowercase' => 'Почта должна быть написана строчными буквами',
            'email' => 'Почта должна быть действительной',
            'max' => 'Поле почты не должно превышать :max.',
